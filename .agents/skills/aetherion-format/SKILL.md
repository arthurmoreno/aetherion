---
name: aetherion-format
description: Run the canonical `make format` workflow for the Aetherion engine when the user wants repo-standard formatting for both C++ and Python code before review, testing, or committing changes.
---

# Aetherion Format

Use this skill when the user wants repository-standard formatting.
