...
public:
  ...
  void deserializeFromBytes(
      const std::vector<char> &byteData); // Deserialize from a byte stream
  ...
  void
  msgpack_unpack(msgpack::object const &o); // Msgpack deserialization method

  // --- New Utility Search Methods ---

  std::vector<VoxelGridCoordinates> getAllTerrainInRegion(int x_min, int y_min,
                                                          int z_min, int x_max,
                                                          int y_max,
                                                          int z_max) const;

  std::vector<VoxelGridCoordinates> getAllEntityInRegion(int x_min, int y_min,
                                                         int z_min, int x_max,
                                                         int y_max,
                                                         int z_max) const;

  std::vector<VoxelGridCoordinates> getAllEventInRegion(int x_min, int y_min,
                                                        int z_min, int x_max,
                                                        int y_max,
                                                        int z_max) const;

  std::vector<VoxelGridCoordinates> getAllLightingInRegion(int x_min, int y_min,
                                                           int z_min, int x_max,
                                                           int y_max,
                                                           int z_max) const;

  // Methods to retrieve entity IDs within a region
  std::vector<int> getAllTerrainIdsInRegion(int x_min, int y_min, int z_min,
                                            int x_max, int y_max, int z_max,
                                            VoxelGridView &gridView) const;

  std::vector<int> getAllEntityIdsInRegion(int x_min, int y_min, int z_min,
                                           int x_max, int y_max, int z_max,
                                           VoxelGridView &gridView) const;

  std::vector<int> getAllEventIdsInRegion(int x_min, int y_min, int z_min,
                                          int x_max, int y_max,
                                          int z_max) const;

  std::vector<int> getAllLightingIdsInRegion(int x_min, int y_min, int z_min,
                                             int x_max, int y_max,
                                             int z_max) const;
