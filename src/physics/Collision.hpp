...
inline std::tuple<bool, int, int, int>
hasSpecialCollision(entt::registry &registry, VoxelGrid &voxelGrid,
  ...
  if ((0 <= movingToX && movingToX < voxelGrid.width) &&
    ...
    // int movingToEntityId = voxelGrid.getEntity(movingToX, movingToY,
    // movingToZ);
