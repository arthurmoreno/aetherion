...
inline MovingComponent
initializeMovingComponent(const Position &position, const Velocity &velocity,
  ...
  movingComponent.direction =
      getDirectionFromVelocities(velocity.vx, velocity.vy, velocity.vz);
