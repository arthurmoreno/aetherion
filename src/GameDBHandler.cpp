...
void GameDBHandler::putTimeSeries(const std::string &seriesName,
                                  long long timestamp, double value) {
  // Logger::getLogger()->debug(
  //     "[GameDBHandler::putTimeSeries] Called with seriesName={},
  //     timestamp={}, value={}", seriesName, timestamp, value);
...
GameDBHandler::queryTimeSeries(const std::string &seriesName, long long start,
                               long long end) {
  // Logger::getLogger()->info(
  //     "[GameDBHandler::queryTimeSeries] Called with seriesName={}, start={},
  //     end={}", seriesName, start, end);
  ...
  // Logger::getLogger()->info("Found {} results in time series query for {}",
  // results.size(),
  //                           seriesName);
  return results;
}

void GameDBHandler::executeSQL(const std::string &sql) {
  gameDB->executeSQL(sql);
}
