...
protected:
  ...
  static QueryResponseHeader deserializeHeader(const char *data, size_t size,
                                               size_t &offset) {
...
public:
  ...
  static ListStringResponse *deserialize(const char *data, size_t size,
                                         size_t &offset) {
    size_t consume_len = 0;
...
public:
  ...
  static ListDoubleResponse *deserialize(const char *data, size_t size,
                                         size_t &offset) {
    size_t consume_len = 0;
...
public:
  ...
  static MapOfMapsResponse *deserialize(const char *data, size_t size,
                                        size_t &offset) {
    size_t consume_len = 0;
    auto map_result = struct_pack::deserialize<
...
public:
  ...
  static MapOfListsOfDoubleResponse *deserialize(const char *data, size_t size,
                                                 size_t &offset) {
    size_t consume_len = 0;
    auto map_result =
        struct_pack::deserialize<std::map<std::string, std::vector<double>>>(
            data + offset, size - offset, consume_len);
    if (!map_result) {
...
public:
  ...
  static MapOfMapsOfDoubleResponse *deserialize(const char *data, size_t size,
                                                size_t &offset) {
    size_t consume_len = 0;
    auto map_result = struct_pack::deserialize<
