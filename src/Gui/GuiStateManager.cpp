...
bool GuiStateManager::getTerrainCameraStats() const {
  return terrainCameraStats;
}

bool GuiStateManager::getHoveredEntityInterfaceStats() const {
  return hoveredEntityInterfaceStats;
}
...
void GuiStateManager::setHoveredEntityInterfaceStats(
    const bool hoveredEntityInterfaceStats) {
...
const bool getWaterCameraStats() {
  return GuiStateManager::Instance()->getWaterCameraStats();
}

const bool getTerrainCameraStats() {
  return GuiStateManager::Instance()->getTerrainCameraStats();
}
