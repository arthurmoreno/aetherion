...
/**
 * @brief Console Program - Shell-like terminal interface for debugging and
 * system control
 *
 * Provides a bash/sh-like terminal interface with command history, output
 * display, and command execution. Features include:
...
private:
  ...
  std::vector<std::shared_ptr<TerminalCommand>>
      commandList_; // For ordered display
