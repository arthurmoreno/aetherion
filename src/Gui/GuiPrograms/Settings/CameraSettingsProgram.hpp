...
public:
  void render(GuiContext &context) override {
    ...
    if (ImGui::Begin("Camera Settings", &isActive_,
                     ImGuiWindowFlags_AlwaysAutoResize)) {
      int CAMERA_SCREEN_WIDTH_ADJUST_OFFSET = nb::cast<int>(
          context.physicsChanges["CAMERA_SCREEN_WIDTH_ADJUST_OFFSET"]);
      int CAMERA_SCREEN_HEIGHT_ADJUST_OFFSET = nb::cast<int>(
          context.physicsChanges["CAMERA_SCREEN_HEIGHT_ADJUST_OFFSET"]);
