...
class TerminalCommand {
   public:
     ...
     */
    virtual void execute(GuiContext& context, std::deque<TerminalLine>& terminalBuffer,
   ...
   protected:
     ...
     */
    void addOutput(std::deque<TerminalLine>& terminalBuffer, const std::string& text,
                   bool isCommand = false, bool isError = false);
};
