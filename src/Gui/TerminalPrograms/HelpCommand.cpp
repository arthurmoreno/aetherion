...
void HelpCommand::execute(GuiContext &context,
  ...
  addOutput(terminalBuffer, "  <command> [params] - Execute custom command",
            false, false);
  addOutput(terminalBuffer, "", false, false);
  addOutput(terminalBuffer,
            "Command format: <type> param1=value1 param2=value2 ...", false,
            false);
  addOutput(terminalBuffer,
            "Navigation: Use Up/Down arrows to navigate history", false, false);
  scrollToBottom = true;
}
