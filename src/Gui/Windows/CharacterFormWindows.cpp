...
void imguiPrepareCharacterFormWindows(nb::list &commands,
  ...
  // Form title
  ImGui::SetCursorPosX(
      (windowSize.x - ImGui::CalcTextSize("CREATE NEW CHARACTER").x) * 0.5f);
  ...
  static char characterDescription[256] =
      "A brave adventurer ready to explore the world";
  ...
  ImGui::BeginChild("CharacterFormScrollRegion", ImVec2(0, -buttonAreaHeight),
  ...
  ImGui::SliderFloat("Experience Multiplier", &experienceMultiplier, 0.5f, 3.0f,
                     "%.2f");
