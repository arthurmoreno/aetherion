...
std::string DefaultNodeGene::to_string() const {
  ...
  oss << "DefaultNodeGene(key=" << key << ", bias=" << bias
      << ", response=" << response << ", activation=" << activation
...
double DefaultNodeGene::distance(const DefaultNodeGene &other,
...
BaseGene *DefaultNodeGene::crossover(const BaseGene &other) const {
  ...
  const DefaultNodeGene &otherNode =
      dynamic_cast<const DefaultNodeGene &>(other);
...
BaseGene *DefaultConnectionGene::crossover(const BaseGene &other) const {
  ...
  const DefaultConnectionGene &otherConn =
      dynamic_cast<const DefaultConnectionGene &>(other);
