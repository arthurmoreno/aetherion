...
from aetherion.audio.exceptions import AudioInitError, AudioLoadError, AudioPlaybackError
...
class MusicAndAmbienceManager(BaseAudioManager):
    ...
    def __init__(self, ambient_channels: int = 4, channel_offset: int = 0) -> None:
        ...
        logger.info(f"MusicAndAmbienceManager initialized: {ambient_channels} ambient channels (offset: {channel_offset})")
