...
constexpr const char* entityMainTypeToString(EntityEnum e) noexcept {
    switch (e) {
        case EntityEnum::TERRAIN:     return "TERRAIN";
        case EntityEnum::PLANT:       return "PLANT";
        case EntityEnum::BEAST:       return "BEAST";
        case EntityEnum::TILE_EFFECT: return "TILE_EFFECT";
    }
    return "UNKNOWN";
}
