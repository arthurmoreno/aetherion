...
Run the canonical build workflow for the Aetherion engine when the user wants to build the package, refresh wheel artifacts, or verify that the project still compiles.
